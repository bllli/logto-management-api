...
type AuthnHasura struct {
	sdkConfiguration sdkConfiguration
}

func newAuthnHasura(sdkConfig sdkConfiguration) *AuthnHasura {
	return &AuthnHasura{
		sdkConfiguration: sdkConfig,
	}
}

// Get - Hasura auth hook endpoint
...
func (s *AuthnHasura) Get(ctx context.Context, resource string, unauthorizedRole *string, opts ...operations.Option) (*operations.GetHasuraAuthResponse, error) {
