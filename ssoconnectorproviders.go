...
type SsoConnectorProviders struct {
	sdkConfiguration sdkConfiguration
}

func newSsoConnectorProviders(sdkConfig sdkConfiguration) *SsoConnectorProviders {
	return &SsoConnectorProviders{
...
func (s *SsoConnectorProviders) List(ctx context.Context, opts ...operations.Option) (*operations.ListSsoConnectorProvidersResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/sso-connector-providers")
	if err != nil {
	...
	res := &operations.ListSsoConnectorProvidersResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out []operations.ListSsoConnectorProvidersResponseBody
