...
func newSentinelActivities(sdkConfig sdkConfiguration) *SentinelActivities {
	return &SentinelActivities{
		sdkConfiguration: sdkConfig,
	}
}

// BulkDelete - Bulk delete sentinel activities
...
func (s *SentinelActivities) BulkDelete(ctx context.Context, request operations.DeleteSentinelActivitiesRequest, opts ...operations.Option) (*operations.DeleteSentinelActivitiesResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/sentinel-activities/delete")
	if err != nil {
	...
	res := &operations.DeleteSentinelActivitiesResponse{
