...
func newDashboardUsers(sdkConfig sdkConfiguration) *DashboardUsers {
	return &DashboardUsers{
		sdkConfiguration: sdkConfig,
	}
}

// GetTotalCount - Get total user count
// Get total user count in the current tenant.
func (s *DashboardUsers) GetTotalCount(ctx context.Context, opts ...operations.Option) (*operations.GetTotalUserCountResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/dashboard/users/total")
	if err != nil {
	...
	res := &operations.GetTotalUserCountResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetTotalUserCountResponseBody
