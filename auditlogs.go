...
func (s *AuditLogs) List(ctx context.Context, request operations.ListLogsRequest, opts ...operations.Option) (*operations.ListLogsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/logs")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out []operations.ListLogsResponseBody
...
func (s *AuditLogs) Get(ctx context.Context, id string, opts ...operations.Option) (*operations.GetLogResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/logs/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetLogResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
