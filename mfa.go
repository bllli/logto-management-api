...
func newMfa(sdkConfig sdkConfiguration) *Mfa {
	return &Mfa{
		sdkConfiguration: sdkConfig,
	}
}

// SkipBinding - Skip MFA binding flow
...
func (s *Mfa) SkipBinding(ctx context.Context, opts ...operations.Option) (*operations.SkipMfaBindingFlowResponse, error) {
