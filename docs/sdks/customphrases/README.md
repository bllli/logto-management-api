...
* [GetAll](#getall) - Get all custom phrases
* [Get](#get) - Get custom phrases
* [Upsert](#upsert) - Upsert custom phrases
* [Delete](#delete) - Delete custom phrase
...
func main() {
    ...
    res, err := s.CustomPhrases.GetAll(ctx)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.CustomPhrases.Get(ctx, operations.GetCustomPhraseLanguageTagTtRu)
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.CustomPhrases.Upsert(ctx, operations.ReplaceCustomPhraseLanguageTagAzAz, components.TranslationObject{})
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.CustomPhrases.Delete(ctx, operations.DeleteCustomPhraseLanguageTagHtHt)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
