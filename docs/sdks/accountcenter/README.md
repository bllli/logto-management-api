...
* [Get](#get) - Get account center settings
* [UpdateSettings](#updatesettings) - Update account center settings
...
func main() {
    ...
    res, err := s.AccountCenter.Get(ctx)
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.AccountCenter.UpdateSettings(ctx, operations.UpdateAccountCenterSettingsRequest{})
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
