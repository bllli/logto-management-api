...
* [CreateByPassword](#createbypassword) - Create a record by password
* [CreateByVerificationCode](#createbyverificationcode) - Create a record by verification code
* [VerifyByCode](#verifybycode) - Verify verification code
* [CreateBySocial](#createbysocial) - Create a social verification record
* [VerifyBySocial](#verifybysocial) - Verify a social verification record
...
func main() {
    ...
    res, err := s.Verifications.CreateByPassword(ctx, operations.CreateVerificationByPasswordRequest{
        Password: "MArQFInKHEVJIJt",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Verifications.CreateByVerificationCode(ctx, operations.CreateVerificationByVerificationCodeRequest{
...
func main() {
    ...
    res, err := s.Verifications.VerifyByCode(ctx, operations.VerifyVerificationByVerificationCodeRequest{
        Identifier: operations.VerifyVerificationByVerificationCodeIdentifier{
            Type: operations.VerifyVerificationByVerificationCodeTypeEmail,
            Value: "<value>",
        },
        VerificationID: "<id>",
        Code: "<value>",
...
func main() {
    ...
    res, err := s.Verifications.CreateBySocial(ctx, operations.CreateVerificationBySocialRequest{
        State: "Pennsylvania",
        RedirectURI: "https://corrupt-descendant.org/",
        ConnectorID: "<id>",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Verifications.VerifyBySocial(ctx, operations.VerifyVerificationBySocialRequest{
