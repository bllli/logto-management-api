...
```
speakeasy generate usage -s logto-openapi-source.json -l go -i {INPUT_OPERATION_ID} -o ./samples
```

- To generate samples for an entire namespace (like a tag or group name), use:

```
speakeasy generate usage -s logto-openapi-source.json -l go -n {INPUT_TAG_NAME} -o ./samples
```
