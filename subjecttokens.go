...
func newSubjectTokens(sdkConfig sdkConfiguration) *SubjectTokens {
...
func (s *SubjectTokens) Create(ctx context.Context, request operations.CreateSubjectTokenRequest, opts ...operations.Option) (*operations.CreateSubjectTokenResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/subject-tokens")
	if err != nil {
	...
	res := &operations.CreateSubjectTokenResponse{
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.CreateSubjectTokenResponseBody
