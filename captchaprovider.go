...
func newCaptchaProvider(sdkConfig sdkConfiguration) *CaptchaProvider {
...
func (s *CaptchaProvider) Get(ctx context.Context, opts ...operations.Option) (*operations.GetCaptchaProviderResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/captcha-provider")
	if err != nil {
	...
	res := &operations.GetCaptchaProviderResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetCaptchaProviderResponseBody
...
func (s *CaptchaProvider) Update(ctx context.Context, request operations.UpdateCaptchaProviderRequest, opts ...operations.Option) (*operations.UpdateCaptchaProviderResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.UpdateCaptchaProviderResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.UpdateCaptchaProviderResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
