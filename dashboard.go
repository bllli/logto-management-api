...
// Dashboard - Endpoints that power the dashboard page of Console to show the statistics of the current tenant.
...
func (s *Dashboard) GetNewUserCounts(ctx context.Context, opts ...operations.Option) (*operations.GetNewUserCountsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/dashboard/users/new")
	if err != nil {
	...
	res := &operations.GetNewUserCountsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetNewUserCountsResponseBody
...
// GetActiveUsers - Get active user data
...
func (s *Dashboard) GetActiveUsers(ctx context.Context, date *string, opts ...operations.Option) (*operations.GetActiveUserCountsResponse, error) {
	request := operations.GetActiveUserCountsRequest{
		Date: date,
	}
	...
	opURL, err := url.JoinPath(baseURL, "/api/dashboard/users/active")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetActiveUserCountsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetActiveUserCountsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
