...
func newCaptchaProviders(sdkConfig sdkConfiguration) *CaptchaProviders {
...
func (s *CaptchaProviders) Delete(ctx context.Context, opts ...operations.Option) (*operations.DeleteCaptchaProviderResponse, error) {
	...
	res := &operations.DeleteCaptchaProviderResponse{
