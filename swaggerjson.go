...
func newSwaggerJSON(sdkConfig sdkConfiguration) *SwaggerJSON {
	return &SwaggerJSON{
...
func (s *SwaggerJSON) Get(ctx context.Context, opts ...operations.Option) (*operations.GetSwaggerJSONResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/swagger.json")
	if err != nil {
