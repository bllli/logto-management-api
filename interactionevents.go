...
func newInteractionEvents(sdkConfig sdkConfiguration) *InteractionEvents {
...
func (s *InteractionEvents) Update(ctx context.Context, request operations.UpdateInteractionEventRequest, opts ...operations.Option) (*operations.UpdateInteractionEventResponse, error) {
