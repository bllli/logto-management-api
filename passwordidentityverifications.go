...
type PasswordIdentityVerifications struct {
	sdkConfiguration sdkConfiguration
}

func newPasswordIdentityVerifications(sdkConfig sdkConfiguration) *PasswordIdentityVerifications {
	return &PasswordIdentityVerifications{
...
func (s *PasswordIdentityVerifications) Create(ctx context.Context, request operations.CreateNewPasswordIdentityVerificationRequest, opts ...operations.Option) (*operations.CreateNewPasswordIdentityVerificationResponse, error) {
